---
id: i-types
title: I. Types of Embodiment: Human and Nonhuman Bodies
sidebar_label: I. Types of Embodiment: Human and Nonhuman Bodies
---
...
Within the category of human avatars, 531 are portrayed with female-gendered characteristics (~73% of humans) and 187 are read as male (~26%), with 11 not detailed enough to specify (~1%) (Figure 17).

![Demographic breakdown of the avatars from Chatbots.org](assets/figs/fig-17-graph.png)
<div class="caption"><h4>Figure 17. Demographic breakdown of the avatars from Chatbots.org</h4></div>
...
However, male-gendered conversational agents are not immune. All public communications with Max, the conversational agent included as a docent at the Heinz Nixdorf MuseumsForum (Figure 18), were logged and categorized by Kopp et al., and 11% of behaviors were coded as “Flaming,” including abuse, name-calling, pornographic utterances, random keystrokes, and senseless utterances. They also noted that “Max should be capable of flirting behavior as he is tested in this respect quite frequently.” (Kopp et al., 2005) As a built-in response to any behaviors coded as negative, including obscene or politically incorrect input, Max was programmed to de-escalate rude visitors’ behavior by leaving the scene after repeated insults or bad behavior.

![Max interacting with visitors in the Heinz Nixdorf MuseumsForum](assets/figs/fig-18-max.png)
<div class="caption"><h4>Figure 18. Max interacting with visitors in the Heinz Nixdorf MuseumsForum</h4></div>
...
![Mavis Beacon on the box of the 1987 Mavis Beacon Teaches Typing! for DOS](assets/figs/fig-20-mavis.jpg)
<div class="caption"><h4>Figure 20. Mavis Beacon on the box of the 1987 Mavis Beacon Teaches Typing! for DOS</h4></div>

![Mavis Beacon pictured inside the box of the 1987 Mavis Beacon Teaches Typing](assets/figs/fig-21-mavis.jpg)
<div class="caption"><h4>Figure 21. Mavis Beacon pictured inside the box of the 1987 Mavis Beacon Teaches Typing</h4></div>
...
![Chessmaster 2000 box art,1986](assets/figs/fig-22-chessmaster.jpg)
<div class="caption"><h4>Figure 22. Chessmaster 2000 box art, 1986</h4></div>
...
![The evolution of Betty Crocker](assets/figs/fig-23-betty.jpg)
<div class="caption"><h4>Figure 23. The evolution of Betty Crocker</h4></div>

![Mavis Beacon in the classroom of Version 8](assets/figs/fig-24-mavis.jpg)
<div class="caption"><h4>Figure 24. Mavis Beacon in the classroom of Version 8</h4></div>

![Mavis Beacon in the classroom of Version 11](assets/figs/fig-25-mavis.jpg)
<div class="caption"><h4>Figure 25. Mavis Beacon in the classroom of Version 11</h4></div>

![Mavis Beacon in the classroom of Version 15](assets/figs/fig-26-mavis.jpg)
<div class="caption"><h4>Figure 26. Mavis Beacon in the classroom of Version 15</h4></div>

![Mavis Beacon in the classroom of Version 20](assets/figs/fig-27-mavis.jpg)
<div class="caption"><h4>Figure 27. Mavis Beacon in the classroom of Version 20</h4></div>
...
![Mavis Beacon in 2018](assets/figs/fig-28-mavis.png)
<div class="caption"><h4>Figure 28. Mavis Beacon in 2018</h4></div>
...
<div class="caption"><h4>Software agents do not all have to be white</h4></div>
...
![Luke Swartz’s selection of alternative Office Assistant embodiments](assets/figs/fig-29-assistants.png)
<div class="caption"><h4>Figure 29. Luke Swartz’s selection of alternative Office Assistant embodiments</h4></div>
...
Many robots intended for the home are given zoomorphic embodiments, to make them as non-threatening as domesticated animals. However, this embodiment choice also implies a social role as a domestic companion. Two examples of this form and function in social robots are the Sony AIBO, which takes the form of a robot dog (Figure 30) and the PARO therapeutic robot (Figure 31), which was designed to provide companionship and stress relief to elderly patients in extended care facilities that do not allow real animals.

![Sony AIBO](assets/figs/fig-30-aibo.png)
<div class="caption"><h4>Figure 30. Sony AIBO</h4></div>

![PARO](assets/figs/fig-31-paro.jpg)
<div class="caption"><h4>Figure 31. PARO</h4></div>
...
![Leonardo](assets/figs/fig-32-leonardo.png)
<div class="caption"><h4>Figure 32. Leonardo</h4></div>

![Furby](assets/figs/fig-33-furby.jpg)
<div class="caption"><h4>Figure 33. Furby</h4></div>
...
![Replika icon](assets/figs/fig-34-replika.jpg)
<div class="caption"><h4>Figure 34. Replika icon</h4></div>
...
![“Complex” Replika with fractal pattern](assets/figs/fig-35-replika.png)
<div class="caption"><h4>Figure 35. “Complex” Replika with fractal pattern</h4></div>

![“Naughty” Replika with jack-o-lantern pattern](assets/figs/fig-36-replika.png)
<div class="caption"><h4>Figure 36. “Naughty” Replika with jack-o-lantern pattern</h4></div>

![“Sensitive” Replika with plasma lamp pattern](assets/figs/fig-37-replika.png)
<div class="caption"><h4>Figure 37. “Sensitive” Replika with plasma lamp pattern</h4></div>

![“Spiritual” Replika with amethyst crystal pattern](assets/figs/fig-38-replika.png)
<div class="caption"><h4>Figure 38. “Spiritual” Replika with amethyst crystal pattern</h4></div>
...
![Tamagotchi](assets/figs/fig-39-tamagotchi.jpg)
<div class="caption"><h4>Figure 39. Tamagotchi</h4></div>
...
![Replika interface](assets/figs/fig-40-replika.PNG)
<div class="caption"><h4>Figure 40. Replika interface</h4></div>
...
![Replica interface screen shots](assets/figs/fig-41-replika.png)
<div class="caption"><h4>Figure 41. Replika interface screen shots</h4></div>
...
<div class="caption"><h4>No object is neutral, and users don’t always make the best choices</h4></div>
...
![Human and robot emojis](assets/figs/fig-42-emojis.png)
<div class="caption"><h4>Figure 42. Human and robot emojis</h4></div>

![Human and robot emojis with mixed features](assets/figs/fig-43-emojis.png)
<div class="caption"><h4>Figure 43. Human and robot emojis with mixed features</h4></div>
...
![Human and robot characteristics from “An inventory of reported characteristics for home computers, robots, and human beings: Applications for android science and the uncanny valley” (Ramey, 2006)](assets/figs/fig-44-venn.png)
<div class="caption"><h4>Figure 44. Human and robot characteristics from “An inventory of reported characteristics for home computers, robots, and human beings: Applications for android science and the uncanny valley” (Ramey, 2006)</h4></div>
...
![Selected robot avatars from the Chatbots.org data set](assets/figs/fig-45-chatbots.png)
<div class="caption"><h4>Figure 45. Selected robot avatars from the Chatbots.org data set</h4></div>
...
![Woebot](assets/figs/fig-46-woebot.png)
<div class="caption"><h4>Figure 46. Woebot</h4></div>
...
![Ellie](assets/figs/fig-47-ellie.jpg)
<div class="caption"><h4>Figure 47. </h4></div>
...
![Sara](assets/figs/fig-48-sara.jpg)
<div class="caption"><h4>Figure 48. Sara</h4></div>
...
![Woebot in the office](assets/figs/fig-49-woebot.png)
<div class="caption"><h4>Figure 49. Woebot in the office</h4></div>

![Woebot celebrating Gay Pride](assets/figs/fig-50-woebot.jpg)
<div class="caption"><h4>Figure 50. Woebot celebrating Gay Pride</h4></div>

![Woebot in the lab](assets/figs/fig-51-woebot.PNG)
<div class="caption"><h4>Figure 51. Woebot in the lab</h4></div>
...
![Woebot interface with introductory message](assets/figs/fig-52-woebot.PNG)
<div class="caption"><h4>Figure 52. Woebot interface with introductory message</h4></div>

![Woebot interface asking for the user’s mood](assets/figs/fig-53-woebot.PNG)
<div class="caption"><h4>Figure 53. Woebot interface asking for the user’s mood</h4></div>

![Woebot interface asking for the user’s gender](assets/figs/fig-54-woebot.PNG)
<div class="caption"><h4>Figure 54. Woebot interface asking for the user’s gender</h4></div>

![Woebot interface with video and chat options](assets/figs/fig-55-woebot.PNG)
<div class="caption"><h4>Figure 55. Woebot interface with video and chat options</h4></div>
...
<div class="caption"><h4>Robots with friendly features are a great alternative to human embodiments</h4></div>
